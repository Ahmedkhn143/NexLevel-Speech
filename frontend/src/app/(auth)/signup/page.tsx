        ...
        <div className="min-h-screen flex items-center justify-center p-4">
            ...
            <div className="absolute inset-0 overflow-hidden">
                <div
                    ...
                    style={{
                        background: 'radial-gradient(circle, hsl(220, 80%, 55%, 0.15) 0%, transparent 70%)',
                        top: '-200px',
                        right: '-100px',
                    }}
                />
            ...
            >
                ...
                <div className="card">
                    ...
                    {/* Google OAuth */}
                    <button className="w-full py-3 px-4 rounded-xl border border-gray-700 flex items-center justify-center gap-3 hover:bg-gray-800 transition-colors">
